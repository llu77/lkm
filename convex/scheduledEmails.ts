// Note: This file contains both actions and queries
// Removed "use node" directive as it prevents queries from being defined
// Only specific actions that need Node.js should use "use node"
